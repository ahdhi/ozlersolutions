...
export const metadata = {
  ...
  description:
    'Ozler Care Solutions security policy. Technical and organisational measures for protecting information assets, data encryption, access controls, and incident response procedures.',
  alternates: { canonical: '/security' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Security Policy — Ozler Care Solutions',
    description: 'Technical and organisational measures for protecting information assets, data encryption, access controls, and incident response procedures.',
    url: '/security',
  },
};
...
const tocItems = [
  ...
  { id: 'governance', label: '2. Security Governance' },
  { id: 'infrastructure', label: '3. Infrastructure Security' },
  { id: 'data-security', label: '4. Data Security' },
  { id: 'application', label: '5. Application Security' },
  { id: 'access-control', label: '6. Access Control' },
  { id: 'logging', label: '7. Logging & Monitoring' },
  { id: 'vulnerability', label: '8. Vulnerability Management' },
  { id: 'incident-response', label: '9. Incident Response' },
  { id: 'business-continuity', label: '10. Business Continuity' },
...
export default function SecurityPage() {
  return (
    <>
      <PageHero breadcrumbs={[{ label: 'Home', href: '/' }, { label: 'Security Policy' }]} title="Security Policy" description="Our technical and organisational measures for protecting your data, infrastructure, and information assets.">
      ...
      <Section>
        <div className="max-w-7xl mx-auto flex gap-12">
          ...
          <div className="flex-1 min-w-0 prose prose-slate prose-lg legal-prose">
            ...
            <h2 id="purpose-scope">1. Purpose and Scope</h2>
            <h3>1.1 Purpose</h3>
            <p>This Security Policy (&ldquo;Policy&rdquo;) describes the technical and organisational security measures implemented by Ozler Tech Pty Ltd, trading as Ozler Care Solutions (&ldquo;Ozler,&rdquo; &ldquo;we,&rdquo; &ldquo;our&rdquo;), to protect the confidentiality, integrity, and availability of Customer Data, personal information, and the Services. This Policy forms part of our contractual commitments to Customers and supplements the <a href="/privacy" className="text-oz-blue">Privacy Policy</a> and <a href="/terms" className="text-oz-blue">Terms of Service</a>.</p>
            <h3>1.2 Scope</h3>
            ...
            <h2 id="governance">2. Security Governance</h2>
            ...
            <h2 id="infrastructure">3. Infrastructure Security</h2>
            ...
            <h2 id="application">5. Application Security</h2>
            ...
            <h2 id="access-control">6. Access Control</h2>
            ...
            <h2 id="logging">7. Logging, Monitoring, and Detection</h2>
            <h3>7.1 Logging</h3>
            <ul>
            ...
            <h2 id="vulnerability">8. Vulnerability Management</h2>
            ...
            <h2 id="business-continuity">10. Business Continuity and Disaster Recovery</h2>
            ...
            <h2 id="third-party">11. Third-Party and Vendor Security</h2>
            ...
            <div className="not-prose bg-slate-50 border border-slate-200 rounded-xl p-6 space-y-3 my-6">
              <div className="flex items-center gap-3">
                <LockClosedIcon className="w-5 h-5 text-oz-blue flex-shrink-0" />
                <span className="text-slate-600">Security: <a href="mailto:security@ozlercare.com.au" className="text-oz-blue hover:underline">security@ozlercare.com.au</a></span>
              </div>
              <div className="flex items-center gap-3">
